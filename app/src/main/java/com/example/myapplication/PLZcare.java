...
public class PLZcare extends AppCompatActivity implements View.OnClickListener {
    ...
    //받아온 arraylist를 jsonarray로 변경
    ArrayList<String> arrayList = VO.getrArray();
...
/*    JSONArray jsonArray = new JSONArray();
    ...
    public void init(){
        ...
        for(int i = 0; i <arrayList.size(); i++){
            jsonList.add(Integer.parseInt(arrayList.get(i)));
        }
/*        jsonList.add(10);
        jsonList.add(3);
        jsonList.add(1);
    ...
    private void LineChartGraph(ArrayList labelList, ArrayList valList){
        ...
        LineChart lineChart = (LineChart) findViewById(R.id.eye_chart);
